...
public class Method3 {
	...
	public static void test1(String a, int b) {
		System.out.println("매개변수가 두개이고 첫번째 매개변수는 String, 두번째 매개변수는 int" + "인 test1");
		
	}
	public static void test1(int num1 , String num2) {
		System.out.println("매개변수가 두개이고 첫번째 매개변수는 int, 두번째 매개변수는 String" + "인 test1");
	}
